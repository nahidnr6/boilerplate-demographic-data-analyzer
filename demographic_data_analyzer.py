...
def calculate_demographic_data(print_data=True):
    ...
    non_percentage_higher = len(higher_education_df[higher_education_df.salary == '>50K'])
    higher_education_rich = round(non_percentage_higher / len(higher_education_df) * 100, 1)

    non_percentage_lower = len(lower_education_df[lower_education_df.salary == '>50K'])
    lower_education_rich = round(non_percentage_lower / len(lower_education_df) * 100, 1)
